...
- Listing is used to organise content in **Projects, Talks, Blog** sections
...
Compared to the Minimal template, **Projects** page contains more complex structures: page listing makes it possible to organise topics in various layouts. This can be achieved by editing the `yaml` header in `projects/index.qmd`. 
...
More inforrmation on page listing can be read [here](https://quarto.org/docs/websites/website-listings.html).
