...
<img src="img/v_min_1.png" align="center" width="600" /></a>
  ...
  navbar:
    left:
      ...
      - href: about.qmd
        text: About
```
It is straightfoward to understand where to find the relevant files in order to change the text. For example, 
...
Quarto has a few templates for the About page. Read more [here](https://quarto.org/docs/websites/website-about.html).
<img src="img/v_min_4.png" align="center" width="600" /></a>
...
2. speficy where you want to place the new content in `_quarto.yml`. 
